...
This tutorial is to be used with [GetPlayerColor](../../functions/GetPlayerColor), if you do not use [SetPlayerColor](../../functions/SetPlayerColor) in your script when players connect.
